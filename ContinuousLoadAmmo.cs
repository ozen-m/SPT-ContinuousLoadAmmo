...
[BepInPlugin("com.ozen.continuousloadammo", "Continuous Load Ammo", "1.1.5")]
...
public class ContinuousLoadAmmo : BaseUnityPlugin
{
    ...
    public void Awake()
    {
        ...
        MagPresetFallback = Config.Bind("General", "Mag Preset Fallback", true, new ConfigDescription("Fallback to quick load if magazine preset is unavailable", null, new ConfigurationManagerAttributes() { Order = 3 }));
