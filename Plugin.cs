...
namespace ContinuousLoadAmmo
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            ReachableOnly = Config.Bind("General", "Reachable Places Only", true, new ConfigDescription("Allow loading ammo outside the inventory only when Magazine and Ammo is in your Vest or Pockets", null, new ConfigurationManagerAttributes() { Order = 8 }));
            WeaponTopLoad = Config.Bind("General", "Allow Weapon Top Loading", false, new ConfigDescription("Allow loading weapon ammo in equipped weapon slots outside the inventory", null, new ConfigurationManagerAttributes() { Order = 7 }));
