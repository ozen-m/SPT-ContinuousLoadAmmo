...
namespace ContinuousLoadAmmo
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        protected void Awake()
        {
            ...
            InventoryTabs = Config.Bind("General", "Inventory Tabs", true, new ConfigDescription("Allow loading ammo when switching to/from the maps tab, tasks tab, etc.", null, new ConfigurationManagerAttributes() { Order = 7 }));
