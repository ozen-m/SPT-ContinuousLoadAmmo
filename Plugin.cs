...
{
    [BepInPlugin("com.ozen.ContinuousLoadAmmo", "ContinuousLoadAmmo", "1.0.7")]
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            WeaponTopLoad = Config.Bind("General", "Allow Weapon Top Loading", false, new ConfigDescription("Allow loading weapon ammo in equipped weapon slots outside the inventory", null, new ConfigurationManagerAttributes() { Order = 5 }));
